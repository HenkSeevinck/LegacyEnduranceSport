...
class InternalStatusProvider with ChangeNotifier {
  ...
  List<Map<String, dynamic>> homePageOptions = [
    {'selection': 'myProfile', 'pageName': 'PROFILE', 'icon': Icons.person, 'navigateTo': UserProfile(isCoachView: false, formEditable: true), 'coachOnly': false, 'image': 'images/Profile.png'},
    {'selection': 'myGoals', 'pageName': 'GOALS', 'icon': Icons.flag_outlined, 'navigateTo': GoalsPage(isCoachView: false), 'coachOnly': false, 'image': 'images/Goals.png'},
